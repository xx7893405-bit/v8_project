...
| ANL-001 | in_progress | Analysis / `codex/contract-benchmark-analysis` | MGR-001 | comparison runner、analysis tests、獨立 reports | V2/A/BearS 同 snapshot/config；risk 5%、20x；全期＋2026-07；return/MDD/trades/win/PF |
